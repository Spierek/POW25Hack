...
public class SwipeControl : MonoBehaviour {
	...
	public int currentValue = 0; // current value
	...
	private float smoothDragOffset = 0.2f; //how far (% of the width of one element) do we have to drag to set it to change currentValue?
